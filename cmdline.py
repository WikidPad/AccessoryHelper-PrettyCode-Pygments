...
from .lexers import get_all_lexers, get_lexer_by_name, guess_lexer, \
    load_lexer_from_file, get_lexer_for_filename, find_lexer_class_for_filename
from .lexers.special import TextLexer
from .formatters.latex import LatexEmbeddedLexer, LatexFormatter
...
def main_inner(popts, args, usage):
    ...
    if not outfn and sys.platform in ('win32', 'cygwin') and \
       fmter.name in ('Terminal', 'Terminal256'):  # pragma: no cover
        ...
        if sys.version_info > (3,):
            from .util import UnclosingTextIOWrapper
