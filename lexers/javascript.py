...
from ..lexer import RegexLexer, include, bygroups, default, using, \
    this, words, combined
from ..token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Other
from ..util import get_bool_opt, iteritems
import ..unistring as uni
...
class LassoLexer(RegexLexer):
    ...
    def __init__(self, **options):
        ...
        if self.builtinshighlighting:
            from ._lasso_builtins import BUILTINS, MEMBERS
